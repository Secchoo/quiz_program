...
def quiz_question_saver(question, answers, correct_answer_choice):
    ...
    try:
        ...
        print(f"An error occurred while saving the question: {e}")
...
def main():
    ...
    try:
        ...
        print("All questions are saved in quiz_record.txt")
